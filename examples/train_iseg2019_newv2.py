...
def main():
    ...
    print(model)
    criterion = DiceLoss(classes=args.classes,skip_background_class=True)
...
def get_arguments():
    ...
    parser.add_argument('--model', type=str, default='UNET3D',
                        choices=('VNET', 'VNET2', 'UNET3D', 'DENSENET1','DENSEVOXELNET', 'DENSENET2', 'DENSENET3', 'HYPERDENSENET','RESNETMED3D'))

...
def main():
    ...
    training_generator, val_generator,test_generator, val_volume, test_volume,affine = medical_loaders.generate_datasets(args,
                                                                                               path='.././datasets')
    ...
    trainer = train.Trainer(args, model, criterion, optimizer, train_data_loader=training_generator,
                            valid_data_loader=val_generator, lr_scheduler=None,val_volume = val_volume,test_volume = test_volume)
    trainer.training()
